...
- All commits MUST include a `Signed-off-by` trailer from the human developer (DCO)
- NEVER add `Co-Authored-By`, `Generated by`, or any agent/AI attribution trailers
